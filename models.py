...
class CallRequest(Base):
    ...
    eta_earliest: Mapped[str] = mapped_column(Date)
    eta_latest: Mapped[str] = mapped_column(Date)
...
class RuleSet(Base):
    ...
    max_calls_per_day_per_port: Mapped[int] = mapped_column(Integer, nullable=False, default=3)	
...
class Schedule(Base):
    ...
    call_date: Mapped[str] = mapped_column(Date)
